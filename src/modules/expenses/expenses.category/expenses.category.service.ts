...
class Service {
    ...
    async removeCategoryFromExpense(expense_id: string, reply: FastifyReply) {
        const removedCategory = await ExpensesCategoriesRepository.removeCategoryFromExpense(expense_id);
